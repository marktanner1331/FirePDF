...
namespace FirePDF.Model
{
    ...
    /// not sure where
    /// maybe a static function in rendering.*
    /// </summary>
    public class Mask
    {
        ...
        public Mask(PdfStream image, int maskWidth, int maskHeight) : this(image.GetDecompressedStream(), image.UnderlyingDict, maskWidth, maskHeight)
        {
        }

        public Mask(Stream stream, PdfDictionary underlyingDict, int maskWidth, int maskHeight)
        {
            this.stream = stream;
